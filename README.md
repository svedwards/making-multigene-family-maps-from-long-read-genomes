...
---
title: Making quick maps of multigene families using blast, genome assemblies and
  gggenes
output:
...
Now by blasting to this library (called "scrubjay_9_haps_ren") you can blast to all the individual libraries simultaneously.
